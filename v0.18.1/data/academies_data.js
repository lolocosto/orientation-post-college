/**
 * DonnÃ©es des acadÃ©mies franÃ§aises avec leurs dÃ©partements
 * Source: MinistÃ¨re de l'Ã‰ducation Nationale
 */
...
/**
 * Obtient les dÃ©partements d'une acadÃ©mie
 */
...
/**
 * Obtient le nom d'une acadÃ©mie
 */
...
/**
 * Extrait le dÃ©partement d'un code postal
 * GÃ¨re les cas particuliers : Corse (20), DOM (971-976)
 */
function getDepartementFromCodePostal(codePostal) {
    ...
    if (cp.startsWith('20')) {
        ...
        // On retourne '20' et on cherchera dans les deux dÃ©partements
        return '20';
    }
...
/**
 * Obtient le nom du dÃ©partement Ã  partir de son code
 */
